...
var swiperInit = function swiperInit() {
  ...
  //customized
  var customSwipers = document.querySelectorAll('.customized-swiper')
  customSwipers.forEach(function (swiper) {
    ...
    if (swiper) {
      newSwiper.on(Events.SLIDE_CHANGE, function () {
        unlockEl1.classList.remove('unlocked')
        unlockEl2.classList.remove('unlocked')
